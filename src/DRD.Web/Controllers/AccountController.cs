...
//     - Messages Toastr fortement typés via DRD.Resources.ToastrMessages.
//     - Journalisation via ILogger<T>.
//
// Modifications
//     2025-12-08    Migration totale vers ressources Toastr fortement typées.
//     2025-12-05    Finalisation pour v10.
...
// Ressources fortement typées DRD v10
using DRD.Resources.ToastrMessages;   // ← AccountToastr, GenericToastr
...
namespace DRD.Web.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		public async Task<IActionResult> Login(LoginVM model, string? returnUrl = null)
		{
			...
			{
				TempData["ToastrError"] = AccountToastr.LoginInvalid;
				return View(model);
			}
			...
			if (user is null)
			{
				TempData["ToastrError"] = AccountToastr.UserNotFound;
			...
			if (result.Succeeded)
			{
				TempData["ToastrSuccess"] = AccountToastr.LoginSuccess;
		...
		public async Task<IActionResult> Register(RegisterVM model)
		{
			if (!ModelState.IsValid)
			{
				TempData["ToastrError"] = AccountToastr.RegisterInvalid;
				return View(model);
			}
			...
			TempData["ToastrSuccess"] = AccountToastr.RegisterSuccess;
		...
		public async Task<IActionResult> Logout()
		{
			...
			TempData["ToastrSuccess"] = AccountToastr.LogoutSuccess;
